...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('specialty', models.CharField(choices=[('UX/UI Design', 'Ux Ui'), ('Logo & Branding Design', 'Logo Branding'), ('Web & App Design', 'Web App'), ('Video & Motion Graphics', 'Video Motion'), ('Product & Industrial Design', 'Product Industrial')], max_length=50)),
